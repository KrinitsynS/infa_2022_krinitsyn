...
def draw():
    ...
    for i in range(len(r_circle)):
        if t_circle[i] <= 100 and name[i] == "circle":
            circle(screen, c_circle[i], (x_circle[i], y_circle[i]), r_circle[i])
        if t_circle[i] <= 100 and name[i] == "trigon":
            polygon(screen, c_circle[i], [
                (x_circle[i] + 100, y_circle[i] + 100),
                (x_circle[i] + 100, y_circle[i] - 100),
                (x_circle[i] - 100, y_circle[i])
            ])
